...
export default function MapComponent({
  ...
  useEffect(() => {
    (window as any).refreshLocation = refreshLocation;
    (window as any).resetMapRotation = resetMapRotation;

    return () => {
      delete (window as any).refreshLocation;
      delete (window as any).resetMapRotation;
    };
  }, [isMapReady]);
